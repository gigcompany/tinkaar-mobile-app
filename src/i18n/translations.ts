...
const en: TranslationCatalog = {
  ...
  'onboarding.copy': 'A guided setup for language, cloud sync, your team profile, and ready-to-install apps.',
  ...
  'onboarding.appsCopy': 'Install the apps your team needs now. You can add more later.',
  'onboarding.bundledReady': 'Bundled apps are ready. You can install more templates later from Apps To Install.',
  ...
  'settings.supabaseSync': 'Supabase Sync',
  ...
  'status.connectProject': 'Connect a Supabase project to enable sync.',
...
const hi: Partial<TranslationCatalog> = {
  ...
  'onboarding.copy': 'Choose your language, connect your tenant-owned Supabase project, name your organization, then choose the apps your team needs.',
