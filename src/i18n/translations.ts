...
const en: TranslationCatalog = {
  ...
  'language.copy': 'Tinkaar will use this language for settings and app controls. You can change it later.',
  ...
  'onboarding.privateCopy': 'Create the project in your own Supabase account and run the open-source Tinkaar SQL before connecting this app.',
  ...
  'onboarding.setupStepCopyKeys': 'Copy the project URL and anon/publishable key into Tinkaar.',
  ...
  'onboarding.privateFootnote': 'Tinkaar is not in the runtime data path for this open-source setup.',
  ...
  'onboarding.finishSetup': 'Start Using Tinkaar',
...
const hi: Partial<TranslationCatalog> = {
  ...
  'language.copy': 'Tinkaar सेटिंग्स और ऐप नियंत्रणों के लिए इस भाषा का उपयोग करेगा। आप इसे बाद में बदल सकते हैं।',
...
const ta: Partial<TranslationCatalog> = {
  ...
  'language.copy': 'Tinkaar அமைப்புகள், ஆப் கட்டுப்பாடுகளுக்கு இந்த மொழியை பயன்படுத்தும். பின்னர் மாற்றலாம்.',
...
const te: Partial<TranslationCatalog> = {
  ...
  'language.copy': 'Tinkaar సెట్టింగులు, యాప్ నియంత్రణలకు ఈ భాషను ఉపయోగిస్తుంది. తర్వాత మార్చవచ్చు.',
...
const kn: Partial<TranslationCatalog> = {
  ...
  'language.copy': 'Tinkaar ಸೆಟ್ಟಿಂಗ್‌ಗಳು ಮತ್ತು ಆಪ್ ನಿಯಂತ್ರಣಗಳಿಗೆ ಈ ಭಾಷೆಯನ್ನು ಬಳಸುತ್ತದೆ. ನಂತರ ಬದಲಾಯಿಸಬಹುದು.',
